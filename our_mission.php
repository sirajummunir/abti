...
<div class="wrapper col2">
  <div id="topnav">
    <ul>
      ...
      <li style="float:left" class="active" class="dropdown"><a href="about.php">About us</a>
...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage">
      <center><h1><strong>America Bangladesh Training Institute</strong></h1></center>
	  <p>
<strong>Mission:</strong> 
<br><br>
The mission of America Bangladesh Training Institute is to provide the community with the most innovative, state-of-the-art, and comprehensive communications, information technology, and software system solutions through a highly motivated, creative, experienced, and talented team of professionals contributing to the success and satisfaction of the industries and customers we serve.
